        ...
        <div className="bg-card rounded-3xl p-6 border border-border/60 shadow-card space-y-4">
          <div>
            ...
            <select value={schoolId} onChange={e => setSchoolId(e.target.value)}
              className="w-full bg-secondary/60 border border-border rounded-2xl pl-4 pr-6 py-3 text-sm outline-none select-polished focus:ring-2 focus:ring-primary/30 focus:border-primary">
